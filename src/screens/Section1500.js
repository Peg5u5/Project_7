    ...
    <LinearGradient colors={['#87CEEB', '#00BFFF']} style={{ flex: 1 }}>
      ...
      <View style={{ flex: 1 }}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center' }}>
          <HeadLink
            title="Map1"
            onPress={() => navigation.navigate('Map1_1500')}
